...
<div class="wrap-body">
	<header class="zerogrid">
		<div class="logo">
			<hr class="line-1">
			<a href="#">Exotica</a>
			<span>Dine for a better living</span>
			<hr class="line-1">
		</div>
		<div id='cssmenu' class="align-center">
			<ul>
			   <li class="active"><a href='#Login'><span>Login</span></a></li>
			   <li class=' has-sub'><a href='Register.jsp'><span>Register</span></a></li>
			   <li class='last'><a href='contact.html'><span>Contacts</span></a></li>
			</ul>
			<div id = "Login" class="wrap-container">
	            <jsp:include page="/Login.jsp"></jsp:include>       
	         </div>
	         <%-- <div id = "register" class="wrap-container">
			...
			<div class="wrap-footer">
				<div class="zerogrid">
					<div class="row">
						<div class="col-1-3">
							<div class="wrap-col">
								<p>Copyright - Designed by Madhumitha & Mridhoula</a></p>
							</div>
						</div>
						<div class="col-1-3">
							<div class="wrap-col">
