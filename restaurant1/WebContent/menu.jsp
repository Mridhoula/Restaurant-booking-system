	...
	<header class="zerogrid">
		...
		<div id='cssmenu' class="align-center">
			...
			<ul>
			   ...
			   <li class="active"><a href='#'><span>Add Item</span></a></li>
			   ...
			   <li class='last'><a href='Datagrid.jsp'><span>Item List</span></a></li>
									...
									<div id="contact_form">
										<form name="form1" id="ff" method="post" action="menu"  enctype = "multipart/form-data">
											<label class="row">
											    ...
											    <div class="col-1-2">
												    <div class="wrap-col">
														      <select name="footype"  class="inputtype"><option value="starter">starter</option><option value="main_course">main course</option><option value="dessert">dessert</option></select>
														</div>
											    </div>
											    </label>
											    <label class="row">
												...
												<div class="col-1-2">
													<div class="wrap-col">
													      <span>IMAGE OF THE ITEM</span>
													</div>
											    </div>
												<div class="col-1-2">
													<div class="wrap-col">
														<input type="file"  name="image" width="60"  class="browse" placeholder="Select Picture"  class="inputtype" >
													</div>
												</div>
												</label>
												<label class="row">
												...
												<div class="col-1-2">
													<div class="wrap-col">
														<textarea rows="2" cols="30" name="desc"  class="inputtype"></textarea>
													</div>
												</div>
												</label>
												<label class="row">
												...
												<div class="col-1-2">
													<div class="wrap-col">
														<input type="text" name="price"  class="inputtype">
													</div>
												</div>
											</label>
