  ...
  <div class="wrap-body">
	<header class="zerogrid">
		...
		<div id='cssmenu' class="align-center">
			<ul>
			   <li class="active"><a href='Login.jsp'><span>BOOK TABLE</span></a></li>
			   <li class='last'><a href='Register.jsp'><span>UPCOMING</span></a></li>
									...
									<div id="contact_form">
										<form name="form1" id="ff" method="post" action="login">
											<label class="row">
												<div class="col-1-2">
													<div class="wrap-col">
													      <select name="hotelname" required="required" class="inputtype">
													      <option value="default">Select hotelname</option>
													      </select>
													</div>
											    </div>
												<div class="col-1-2">
